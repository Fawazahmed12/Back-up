...
@Component({
  selector: 'app-section-drop-down-program',
  templateUrl: './section-drop-down-program.component.html',
  styleUrls: ['./section-drop-down-program.component.scss']
})
export class SectionDropDownProgramComponent {
  accordionList = [
    {
      "id": 1,
      "title": "Section 1",
