...
@Component({
  selector: 'app-drag-and-drop-program',
  templateUrl: './drag-and-drop-program.component.html',
  styleUrls: ['./drag-and-drop-program.component.scss']
})
export class DragAndDropProgramComponent {
  meals = [
    {
      "idMeal": "52768",
  ...
  onDragStart(event: DragEvent, meal: any) {
    event.dataTransfer?.setData('text/plain', JSON.stringify(meal));
  }
